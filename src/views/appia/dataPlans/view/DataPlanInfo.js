					...
					<Col xl="6" lg="12" className="mt-2 mt-xl-0">
						<div className="user-info-wrapper">
							<div className="d-flex flex-wrap align-items-center mb-1">
								...
								<CardText className="mb-0">{selectedPlan.product_id}</CardText>
							</div>
							<div className="d-flex flex-wrap align-items-center mb-1">
								<div className="d-flex align-items-center">
								...
								<CardText className="mb-0">{selectedPlan.network}</CardText>
							</div>
							<div className="d-flex flex-wrap align-items-center mb-1">
								<div className="d-flex align-items-center">
								...
								<CardText className="text-capitalize mb-0">
									{selectedPlan.price.toLocaleString('en-ZA', { style: 'currency', currency: 'ZAR' })}
								</CardText>
							</div>
						</div>
					</Col>
					<Col xl="6" lg="12" className="mt-2 mt-xl-0">
						<div className="user-info-wrapper">
							<div className="d-flex flex-wrap align-items-center mb-1">
								...
								<CardText className="text-capitalize mb-0">{selectedPlan.category}</CardText>
							</div>
							<div className="d-flex flex-wrap align-items-center mb-1">
								<div className="d-flex align-items-center">
									<div className="color-box bg-light-secoundary">
