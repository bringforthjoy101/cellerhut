					...
					<Col xl="6" lg="12" className="d-flex flex-column justify-content-between border-container-lg">
							...
							<div className="d-flex justify-content-start">
								...
								<div className="d-flex flex-column ml-1">
									<div className="user-info mt-2">
										...
										<CardText tag="span">{selectedUser !== null ? selectedUser.user_details.email : 'eleanor.aguilar@gmail.com'}</CardText>
									</div>
								</div>
							</div>
						</div>
						<div className="d-flex align-items-center user-total-numbers">
							<div className="d-flex align-items-center mr-2">
								...
								<div className="ml-1">
									<h5 className="mb-0">{selectedUser.user_details.naira_wallet.toLocaleString('en-ZA', { style: 'currency', currency: 'ZAR' })}</h5>
						...
						<div className="mt-3 mr-5">
							<div className="d-flex flex-wrap justify-content-between align-items-center">
								...
								<CardText className="mb-0">{selectedUser !== null ? selectedUser.user_details.user_id : 'eleanor.aguilar'}</CardText>
							</div>
							...
							<div className="d-flex flex-wrap justify-content-between align-items-center my-50">
								...
								<CardText className="text-capitalize mb-0">{selectedUser.user_details.phone}</CardText>
							</div>
						</div>
					</Col>
					<Col xl="6" lg="12" className="mt-2 mt-xl-0">
						<div className="user-info-wrapper">
							{selectedUser?.user_bank_details !== null ? (
								<div className="mt-2">
									<div className="user-info-title">
