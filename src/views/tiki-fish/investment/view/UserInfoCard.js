          ...
          <Col xl='6' lg='12' className='d-flex flex-column justify-content-between border-container-lg'>
            ...
            <div className='d-flex align-items-center user-total-numbers'>
              ...
              <div className='d-flex align-items-center'>
                ...
                <div className='ml-1'>
                  <h5 className='mb-0'>{getTotalInvestedAmount(investmentPackageDetails.investmentSubscriptions).toLocaleString('en-ZA', { style: 'currency', currency: 'ZAR' })}</h5>
          ...
          <Col xl='6' lg='12' className='mt-2 mt-xl-0'>
            <div className='user-info-wrapper'>
                <div className='d-flex flex-wrap align-items-center mt-0'>
                  ...
                  <CardText className='mb-0 text-capitalize'>{investmentPackageDetails?.minimumAmount.toLocaleString('en-ZA', { style: 'currency', currency: 'ZAR' })}</CardText>
                </div>
