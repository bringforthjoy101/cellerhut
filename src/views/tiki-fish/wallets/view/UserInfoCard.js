                          ...
                          <Button.Ripple color='primary' type='submit'>
                            <span className='ml-50'>Save Changes</span>
										...
										{userRole === 'admin' || userRole === 'store' ? (
											<Button.Ripple className="ml-1" color="danger" outline onClick={() => handleDelete(walletDetails.id)}>
												Delete
											</Button.Ripple>
										) : (
											''
                ...
                <div className='ml-1'>
                  ...
                  <small>Total Patronage</small>
							...
							<div className="d-flex align-items-center">
								...
								<div className="ml-1">
									<h5 className="mb-0">{walletDetails.balance.toLocaleString('en-ZA', { style: 'currency', currency: 'ZAR' })}</h5>
