...
export const columns = [
		...
		cell: (row) => (
			<div className="d-flex justify-content-left align-items-center">
				...
				<div className="d-flex flex-column">
					<Link to={`/wallets/view/${row.id}`} className="user-name text-truncate mb-0">
	...
	},
	{
		...
		selector: 'overdraft',
		sortable: true,
		cell: (row) => <span className="text-capitalize">{row.overdraft.toLocaleString('en-ZA', { style: 'currency', currency: 'ZAR' })}</span>,
	},
	// {
	//   name: 'Status',
	//   minWidth: '80px',
	...
	// },
	{
		...
		cell: (row) => (
			<UncontrolledDropdown>
				...
				<DropdownMenu right>
					<DropdownItem tag={Link} to={`/wallets/view/${row.id}`} className="w-100">
