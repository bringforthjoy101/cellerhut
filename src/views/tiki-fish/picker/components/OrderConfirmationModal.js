...
const OrderConfirmationModal = ({ 
  ...
  const isValidCashAmount = !isCashPayment || (cashCollected && parseFloat(cashCollected) >= parseFloat(orderData.total))
  ...
  const handleCashChange = (e) => {
    ...
    if (value && parseFloat(value) < parseFloat(orderData.total)) {
    ...
    <Modal isOpen={isOpen} toggle={toggle} size="lg" centered>
      ...
      <ModalFooter>
        ...
        <Button 
          ...
          disabled={!isValidCashAmount || isLoading}
        >
